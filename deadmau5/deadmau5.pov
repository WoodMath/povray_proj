...
#declare f_floor_extend = 5.0;
#declare f_floor_offset = 0.20;
#declare f_floor_height = 0.25;
#declare obj_floor = box{
	<1,1,1>,
	<-1,-1,-1>
	scale f_sphere_large_radius*f_floor_extend*(x+z)+f_floor_height*y 
	material{mat_floor} 
	translate vect_sphere_center-(f_sphere_large_radius+f_floor_offset)*y
}
object{obj_floor}
